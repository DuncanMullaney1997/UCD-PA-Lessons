...
#Predict the probabilities for class 0 and for class 1 of the testing data.
# Class 0 is located as the first column in the predicted probabilities, and class 1 is the second one
...
# Great work! Did you notice how the model with higher degree of penalization(low C) has lower accuracy
# than the one with very little penalization(high C)? We often sacrifice some accuracy when we regularize
# a model but the benefit is lower complexity and lower chance of overfitting.
# ------------------------------------------------------------------------
...
#     Accuracy of model 2:  0.8174061433447098
...
#      [0.04266212 0.14846416 0.01535836]
#      [0.02730375 0.05290102 0.08532423]]
#
# Excellent effort! You have trained a more and less flexible logistic regressions to predict the sentiment of tweets
# and evaluated them using different performance metrics. In this case, we again sacrificed some accuracy when we imposed regularizarion.
# ------------------------------------------------------------------------
# FINAL PART - BRINGING IT ALL TOGETHER
# ------------------------------------------------------------------------
# myFile = '/Users/duncan/Library/Application Support/JetBrains/PyCharmCE2021.3/scratches/positive_reviews.txt'
...
# positive_reviews = text_file.read()
# # close file
# text_file.close()
# # |
# # |
